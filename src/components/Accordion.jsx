  ...
  return (
    <div className="w-full md:max-w-xl space-y-4">
      ...
      <AccordionItem
        ...
        answer="I see myself as a fast learner but, I'm a big fan of React (and everything related to it). I also really like working with Tailwind Css or Styled-components. I've solid base in Php and Symfony and I'm also comfortable with HTML, pure Css/Sass and Vanilla JS."
      />
      <AccordionItem
